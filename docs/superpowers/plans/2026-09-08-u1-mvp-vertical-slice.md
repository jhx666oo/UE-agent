...
- [x] **Step 2: Run the repository tests to verify red**
...
- [x] **Step 3: Implement the atomic JSON repository**
...
- [x] **Step 4: Add Pydantic request/response schemas and FastAPI dependencies**
...
- [x] **Step 5: Run repository tests to verify green**
...
- [x] **Step 3: Implement the FastAPI app and routes**
...
- [x] **Step 4: Add API test command and local run instructions**
...
- [x] **Step 5: Run all Python tests to verify green**
...
- [x] **Step 4: Implement project creation and project list loading**
...
- [x] **Step 3: Implement parameter grouping and field states**
...
- [x] **Step 4: Implement save/calculate/result states**
...
- [x] **Step 1: Document the two-process local run**
...
- [x] **Step 2: Mark only verified acceptance items**
...
- [x] **Step 4: Commit and push the vertical slice**
